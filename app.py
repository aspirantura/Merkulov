...
from logic import (
    PatientData, make_decision, calc_bsa,
    LEVEL_STANDARD, LEVEL_EXTENDED, LEVEL_CONTRAINDICATED
)
...
st.markdown(
    "*Электронный алгоритм поддержки принятия клинических решений "
    "для детских онкохирургов.*"
)
st.divider()
